...
router.get('/', (req, res) => {
  res.render('index', {
    title: 'Velocity Karts — Ultimate Go Karting Experience',
    features: [
    ...
    testimonials: [
      { name: 'Arjun Mehta', role: 'Weekend Racer', quote: 'Velocity Karts is hands-down the best karting experience I\'ve ever had. The track design is insane!', avatar: 'AM' },
